...
class updateBeneficiosScreen extends StatefulWidget {
  const updateBeneficiosScreen({Key? key}) : super(key: key);

  @override
  _UpdateBeneficiosScreenState createState() => _UpdateBeneficiosScreenState();
}

class _UpdateBeneficiosScreenState extends State<updateBeneficiosScreen> {
                              ...
                              child: TextButton(
                                onPressed: () {
                                  ...
                                  Navigator.of(context).push(
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            AtribuirBeneficiosScreen(colaborador)),
                                  );
                                },
